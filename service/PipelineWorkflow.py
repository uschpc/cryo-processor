...
class PipelineWorkflow:
    ...
    def create_workflow(self):
        ...
        for fraction_file_path in file_list:
            ...
            magick_convert.add_args(dw_jpg_file, jpg_ctf_file, magick_combined_jpg_file, os.path.join(os.path.join(self.shared_scratch_dir, self.wf_name), gctf_log_file.lfn), os.path.join(os.path.join(self.shared_scratch_dir, self.wf_name), mc2_stdout.lfn))
