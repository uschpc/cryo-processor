...
MotionCor2 -InTiff $file1_in -OutMrc $file1_out -Iter 7 -Tol 0.5 -Kv $kev -PixSize $pxsize -FmDose $fmdose -Serial 0 -OutStack 0 -SumRange 0 0 -GpuMemUsage 0.2 -Gpu 1 2> $file1_stderr 1> $file1_stdout & PIDTWO=$!
MotionCor2 -InTiff $file2_in -OutMrc $file2_out -Iter 7 -Tol 0.5 -Kv $kev -PixSize $pxsize -FmDose $fmdose -Serial 0 -OutStack 0 -SumRange 0 0 -GpuMemUsage 0.2 -Gpu 2 2> $file2_stderr 1> $file2_stdout & PIDTHREE=$!
MotionCor2 -InTiff $file3_in -OutMrc $file3_out -Iter 7 -Tol 0.5 -Kv $kev -PixSize $pxsize -FmDose $fmdose -Serial 0 -OutStack 0 -SumRange 0 0 -GpuMemUsage 0.2 -Gpu 3 2> $file3_stderr 1> $file3_stdout & PIDFOUR=$!
