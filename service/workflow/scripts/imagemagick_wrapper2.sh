...
magick convert +append $1 $2 -resize x1024 - | magick convert - -font DejaVu-Sans -fill LightBlue -pointsize 80 -interline-spacing 12 -gravity NorthWest -annotate +40+40 "R: ${resolution}Å" -annotate +40+140 "A: ${asti}" -annotate +40+240 "S: ${shifts/_/ }" $3
#magick "$@"
